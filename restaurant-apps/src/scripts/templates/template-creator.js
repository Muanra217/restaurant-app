...
const createRestoDetailTemplate = (resto) => `
  <div>
    ...
    <img class="resto__poster lazyload" src="${CONFIG.BASE_IMAGE_LARGE + resto.pictureId}" alt="${resto.name}" />
  </div>
...
const createRestoItemTemplate = (resto) => `
    <div class="card">
          <img class="lazyload" src="${CONFIG.BASE_IMAGE_SMALL + resto.pictureId}" alt="${resto.name}" style="width:100%">
          <div class="text-card">
            <a href="${`/#/detail/${resto.id}`}"><h3 tabindex="0" class="resto-name">${resto.name}</h3></a>
